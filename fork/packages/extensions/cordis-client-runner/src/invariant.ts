/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-fork-cordis-client-runner`.
 * @module @deepseek-ai/dsh-fork-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-fork-cordis-client-runner'
