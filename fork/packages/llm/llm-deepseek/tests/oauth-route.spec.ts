...
import { FakeOAuthProvider, OAuthLifecycle } from '@deepseek-ai/dsh-fork-credential-oauth'
import { createDeepSeekOAuthAdapter, resolveAdapterOptions } from '@deepseek-ai/dsh-fork-llm-deepseek'
import type { OAuthCredentialStore } from '@deepseek-ai/dsh-fork-credential-oauth'
import type { CredentialRef } from '@deepseek-ai/dsh-credentials'
import { BlockAssembler } from '@deepseek-ai/dsh-fork-llm'
