...
import LlmRuntime, { createUserMessage, CallId, ReasoningEffortId , createMessage } from '@deepseek-ai/dsh-fork-llm'
import type { Message, ToolSchema } from '@deepseek-ai/dsh-fork-llm'
import { LocalCredentialProvider } from '@deepseek-ai/dsh-credentials-local'
import * as LlmDeepSeek from '@deepseek-ai/dsh-fork-llm-deepseek'
import type { Config } from '@deepseek-ai/dsh-fork-llm-deepseek'
