 ...
 * @module @deepseek-ai/dsh-fork-llm/error
 */

import { isOfficialLlmError } from './official-error.ts'
...
export class HarnessError extends Error {
  ...
  /** Keep fork errors compatible with the official LLM error identity at host boundaries. */
  static override [Symbol.hasInstance](value: unknown): boolean {
    if (value !== null && (typeof value === 'object' || typeof value === 'function')
      && this.prototype.isPrototypeOf(value)) return true
    return this === HarnessError && isOfficialLlmError(value)
  }
