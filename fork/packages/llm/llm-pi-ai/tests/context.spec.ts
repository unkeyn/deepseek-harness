...
import { CallId, createMessage, createUserMessage, OFFLOADED_IMAGE_TEXT } from '@deepseek-ai/dsh-fork-llm'
import type { ContentBlock, GenerateOptions, Message } from '@deepseek-ai/dsh-fork-llm'
