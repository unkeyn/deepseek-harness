...
export interface ResolvedPiAiProviderProfile
  ...
  /** Reference-catalog default reasoning level by model id, applied when neither the request nor the route names one. */
...
export function resolveProfiles(
  ...
  for (const [provider, source] of entries) {
    ...
    resolved.set(provider, {
      ...
      referenceDefaultLevels: routeCatalog.referenceDefaultLevels,
