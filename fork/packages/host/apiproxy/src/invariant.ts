/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-fork-host-apiproxy`.
 * @module @deepseek-ai/dsh-fork-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-fork-host-apiproxy'
