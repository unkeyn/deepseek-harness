 ...
 *
 * @module @deepseek-ai/dsh-fork-compaction-basic/region
 */
...
import { createUserMessage, errorChain } from '@deepseek-ai/dsh-fork-llm'
import type { Message, UserMessage } from '@deepseek-ai/dsh-fork-llm'
import type { TokenMeasurement, TokenMeter } from '@deepseek-ai/dsh-token-meter'
import type { Session, SessionEvent, UserMessage as SessionUserMessage } from '@deepseek-ai/dsh-session'
...
function commitCompactionBody(
  ...
  // Session remains on the official message module while this overlay uses its
  // parallel LLM module; both values have the same durable JSON representation.
  session.append('user/message', checkpointMessage as unknown as SessionUserMessage, {
...
function buildSummarizationInput(
  ...
  const regionMessages = shadowedSeqs
    ...
    .filter(message => message !== null) as unknown as Message[]
  return {
