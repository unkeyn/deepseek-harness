...
export function InputBar({
  ...
  resolveSubmitMode, toggleCommandMenu, stop, command, setCompactionThreshold, setSessionLimit, t,
  renderSlot, useNotices, useLexicon, useMenuLauncher, useCompactionThreshold, useSessionLimit,
  ...
  const sessionLimit = useSessionLimit(value => value)
        ...
        <div className={css.row}>
          ...
          <div className={css.trailing}>
            ...
            <ContextMeter
              ...
              {...setSessionLimit === undefined ? {} : { setSessionLimit }}
