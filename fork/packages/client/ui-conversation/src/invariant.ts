/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-fork-client-ui-conversation`.
 * @module @deepseek-ai/dsh-fork-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-fork-client-ui-conversation'
