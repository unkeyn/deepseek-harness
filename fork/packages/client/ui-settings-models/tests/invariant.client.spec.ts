...
import * as ModelsInvariant from '@deepseek-ai/dsh-fork-client-ui-settings-models/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@deepseek-ai/dsh-fork-client-ui-settings-models')
    apply()
