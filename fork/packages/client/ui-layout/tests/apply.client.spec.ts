...
import { apply as nodeApply } from '@deepseek-ai/dsh-fork-client-ui-layout'
import * as invariant from '@deepseek-ai/dsh-fork-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@deepseek-ai/dsh-fork-client-ui-layout', expect.any(Function))
