/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-fork-client-ui-layout`.
 * @module @deepseek-ai/dsh-fork-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-fork-client-ui-layout'
