...
export interface PluginCardProps {
  ...
  onDiscard: () => void
  /**
   * Render with the controls already disclosed. A card embedded in a surface
   * whose navigation gesture already names it (a Models page segment) starts
   * open; the Plugins tab keeps the collapsed default.
   */
  defaultOpen?: boolean
