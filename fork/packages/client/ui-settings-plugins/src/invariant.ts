/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-fork-client-ui-settings-plugins`.
 * @module @deepseek-ai/dsh-fork-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-fork-client-ui-settings-plugins'
