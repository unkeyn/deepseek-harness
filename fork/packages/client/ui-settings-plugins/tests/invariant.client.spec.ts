...
import * as PluginConfigInvariant from '@deepseek-ai/dsh-fork-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@deepseek-ai/dsh-fork-client-ui-settings-plugins')
