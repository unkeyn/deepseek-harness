/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-fork-client-ui-model-selection`.
 * @module @deepseek-ai/dsh-fork-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-fork-client-ui-model-selection'
