...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Configure credentials to use models from the following providers.',
  edit: 'Edit',
  ...
  deleteDescriptionWithCredential: 'Deleting {provider} removes its configuration and page-managed credentials.',
  ...
  bearerPlaceholder: 'Enter the current Bearer token',
  bearerRequired: 'Enter the Bearer access token.',
  autoRefresh: 'Automatically refresh with Firebase',
  refreshInput: 'Firebase refresh token',
  refreshPlaceholder: 'Enter the refresh token returned by Firebase sign-in',
  refreshRequired: 'Enter the Firebase refresh token.',
  firebaseApiKey: 'Firebase Web API key',
  firebaseApiKeyRequired: 'Enter the public Firebase Web API key.',
  ...
  bearerCustomTitle: 'Bearer provider',
  cookieImport: 'TwinMind cookie export',
  cookieImportPlaceholder: 'Paste the cookie export JSON here',
  cookieImportAction: 'Import session and refresh tokens',
  cookieImportHint: 'Parsed only in this browser. Only session and firebase_refresh_token are saved; the raw export is cleared.',
  customTag: 'Custom',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  deleteDescriptionWithCredential: '删除 {provider} 会移除其配置和由此页面管理的凭证。',
  ...
  bearerPlaceholder: '输入当前 Bearer 令牌',
  bearerRequired: '请输入 Bearer 访问令牌。',
  autoRefresh: '通过 Firebase 自动刷新',
  refreshInput: 'Firebase 刷新令牌',
  refreshPlaceholder: '输入 Firebase 登录返回的刷新令牌',
  refreshRequired: '请输入 Firebase 刷新令牌。',
  firebaseApiKey: 'Firebase Web API 密钥',
  firebaseApiKeyRequired: '请输入公开的 Firebase Web API 密钥。',
  ...
  customTitle: '自定义提供方',
  bearerCustomTitle: 'Bearer 提供方',
  cookieImport: 'TwinMind Cookie 导出',
  cookieImportPlaceholder: '在此粘贴 Cookie 导出 JSON',
  cookieImportAction: '导入会话和刷新令牌',
  cookieImportHint: '仅在此浏览器内解析，只保存 session 和 firebase_refresh_token，随后清空原始导出。',
  customTag: '自定义',
  customRoute: 'Provider ID',
