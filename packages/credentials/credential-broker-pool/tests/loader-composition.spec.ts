...
import { RemoteOAuthCredentialStore } from '@deepseek-ai/dsh-credential-oauth'
import CredentialPoolStore from '@deepseek-ai/dsh-credential-pool-store'
  ...
  it('propagates broker snapshots, applies health eligibility, and disposes remote subscriptions', async () => {
    ...
    context.loader.internal = {
      ...
      async import(specifier: string) {
        ...
        if (specifier === '@deepseek-ai/dsh-credential-broker-pool') return PoolCredentialBroker
    ...
    await context.loader.create({ name: '@deepseek-ai/dsh-credential-broker-pool' })
    await context.loader.await()
