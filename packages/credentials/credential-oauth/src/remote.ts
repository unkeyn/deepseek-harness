...
import type { AuthKind, CredentialBrokerSnapshot, CredentialBrokerSnapshotEntry, CredentialBrokerSnapshotEvent, CredentialBrokerSnapshotSource, CredentialId } from '@deepseek-ai/dsh-credential-broker'
